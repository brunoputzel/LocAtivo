...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Nomes de atributos em português
    |--------------------------------------------------------------------------
    |
    | Cobre tanto os nomes de coluna (snake_case, usados nos Form Requests da
    | API) quanto os nomes de propriedade dos componentes Livewire (camelCase),
    | já que os dois disparam validação pra cima do mesmo domínio.
    */
    ...
    'attributes' => [
        ...
        'foto_url' => 'foto do equipamento',
        'fotoUrl' => 'foto do equipamento',
        'horimetro' => 'horímetro',
        'status' => 'status',
