...
class AtivoControllerTest extends TestCase
{
    ...
    public function test_tipo_ativo_id_precisa_existir_para_cadastrar_ativo(): void
    {
        $gestor = User::factory()->perfil(PerfilUsuario::GESTOR)->create();
        ...
        $response->assertUnprocessable()->assertJsonValidationErrors(['tipo_ativo_id']);
    }
